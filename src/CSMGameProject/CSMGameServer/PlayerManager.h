...
public:
	...
	void SetPlayerName(int _playerId, std::wstring name);
	...
	int GetNewPlayerId();
	int GetPlayersLength(int gameId) { std::map<int,Player*>players; GetPlayers(gameId,&players); return players.size(); };
